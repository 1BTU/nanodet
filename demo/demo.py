...
def parse_args():
    ...
    parser.add_argument("--config", default=r'F:\study\ai\yolo_android\nanodet-main\config\nanodet-plus-m_320.yml',help="model config file path")
    parser.add_argument("--model", default='nanodet-plus-m_320.pth',help="model file path")
    parser.add_argument("--path", default="./pic", help="path to images or video")
